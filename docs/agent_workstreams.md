...
| External utility probes | `contextsafe_hsd/hf_utility.py`, `contextsafe_hsd/models/hsd_advisory_runtime.py`, future probe runtimes under `contextsafe_hsd/models/`, `contextsafe_hsd/auto/` only where advisory lifecycle changes are needed | `docs/planning/utility_probe_integration_plan.md`, `docs/reference/evaluation.md`, `docs/reference/providers_and_models.md` | `tests/test_hf_utility.py`, `tests/test_auto_pipeline.py` |
| Token-policy training and runtime | `contextsafe_hsd/token_policy.py`, `contextsafe_hsd/token_actions.py`, `contextsafe_hsd/models/token_policy_runtime.py`, `contextsafe_hsd/span_providers/token_policy.py` | `docs/runbooks/token_policy_training.md`, `docs/reference/providers_and_models.md` | `tests/test_token_policy.py`, `tests/test_token_actions.py` |
| Candidate generation and reranking | `contextsafe_hsd/rerank.py`, `contextsafe_hsd/dpmlm_candidates.py`, `contextsafe_hsd/local_llm.py` | `docs/reference/pipeline.md`, `docs/reference/providers_and_models.md` | `tests/test_rerank.py`, `tests/test_dpmlm_candidates.py`, `tests/test_local_llm.py` |

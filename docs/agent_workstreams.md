...
| Deterministic masking and style | `privhsd/detectors.py`, `privhsd/pipeline.py`, `privhsd/style.py`, `privhsd/resources/` | `docs/reference/pipeline.md`, `docs/reference/evaluation.md` | `tests/test_pipeline.py`, `tests/test_style_scrubber.py`, `tests/test_synthetic_pii_stress.py` |
